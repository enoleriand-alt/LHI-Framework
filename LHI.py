...
def update():
    os.system(
        "cd .. && rm -rf LHI-Framework && mkdir LHI-Framework && cd LHI-Framework && git clone https://github.com/enoleriand-alt/LHI-Framework.git && echo 'New Directory >> ' && pwd")
...
ex:
python3 LHI.py --spider http://google.com
python3 LHI.py --dork inurl:admin/login.php --country sa --text product
python3 LHI.py --xss "paste url here"
python3 LHI.py --sql "paste url here"
python3 LHI.py --subdomain google.com
python3 LHI.py --RevIP [ip address of server]
python3 LHI.py --word redvirus --type md4
python3 LHI.py --word redvirus --type md5
python3 LHI.py --word redvirus --type sha1
python3 LHI.py --word redvirus --type sha256
python3 LHI.py --word redvirus --type sha512
python3 LHI.py --hash_type 5f4dcc3b5aa765d61d8327deb882cf99
python3 LHI.py --wordpress http://ebase.com/
python3 LHI.py --wordpress http://ebase.com/ --ListUsername /root/Desktop/users.txt --ListPassowrd /root/Desktop/pass.txt
python3 LHI.py --wordpress http://ebase.com/ --ListUsername /root/Desktop/users.txt 
python3 LHI.py --wordpress http://ebase.com/ --ListPassword /root/Desktop/pass.txt
python3 LHI.py --wordpress https://everythingrevelstoke.com --enum use
